def main():
    ...
    location_file = "/usr1/gouallin/blat/sequence_id_to_2bitfile_mapping_smart_split.txt"       # Format: seq_id \t file_location
    output_file = "all_gtdb_seq_species_location_smart_split.txt"    # Output file
